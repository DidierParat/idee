...
public class ContactInfo {
    ...
    public ContactInfo(
            ...
            final String title,
            @JsonProperty(value = TurbaseConstants.ADRESSE1, required = true)
            final String adresse1,
            @JsonProperty(value = TurbaseConstants.ADRESSE2, required = true)
            final String adresse2,
            @JsonProperty(value = TurbaseConstants.ZIP_CODE, required = true)
            final String zipCode,
            @JsonProperty(value = TurbaseConstants.POST_MAIL, required = true)
            final String postMail,
            @JsonProperty(value = TurbaseConstants.PHONE, required = true)
            final int phone,
            @JsonProperty(value = TurbaseConstants.MOBILE, required = true)
            final int mobile,
            @JsonProperty(value = TurbaseConstants.FAX, required = true)
            final int fax,
