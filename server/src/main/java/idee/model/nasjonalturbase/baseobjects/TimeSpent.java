...
public class TimeSpent {
  ...
  public TimeSpent(
      @JsonProperty(value = TurbaseConstants.NORMAL, required = true) final EstimatedTime normal,
      @JsonProperty(value = TurbaseConstants.MIN, required = true) final EstimatedTime min,
      @JsonProperty(value = TurbaseConstants.MAX, required = true) final EstimatedTime max
  ) {
    this.normal = normal;
    this.max = max;
    this.min = min;
