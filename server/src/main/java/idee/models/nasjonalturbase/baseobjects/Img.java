...
public class Img {
  ...
  public Img(
      ...
      @JsonProperty(value = TurbaseConstants.WIDTH, required = true) final int width,
      @JsonProperty(value = TurbaseConstants.HEIGHT, required = true) final int height,
      @JsonProperty(value = TurbaseConstants.SIZE, required = true) final int size
  ) {
    this.url = url;
    this.width = width;
    this.height = height;
