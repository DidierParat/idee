...
public class Group extends BasicData {
  ...
  public Group(
      ...
      @JsonProperty(value = TurbaseConstants.COMPANY_REG, required = false) final String companyReg,
      @JsonProperty(value = TurbaseConstants.LOGO_URL, required = false) final String logoUrl,
      @JsonProperty(value = TurbaseConstants.NB_OF_EMPLOYEES, required = false) final int nbOfEmployees,
      @JsonProperty(value = TurbaseConstants.LINKS, required = false) final List<Link> links,
      @JsonProperty(value = TurbaseConstants.CONTACT_INFO, required = false) final List<ContactInfo> contactInfos,
      @JsonProperty(value = TurbaseConstants.PARENT_GROUP, required = false) final String parentGroup,
