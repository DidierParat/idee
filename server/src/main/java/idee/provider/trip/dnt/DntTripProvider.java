package idee.provider.trip.dnt;

import static idee.provider.common.dnt.DntConstants.MAX_OBJECTS_PER_REQUEST;

import idee.provider.ProviderException;
import idee.provider.client.AdaptiveClient;
import idee.provider.client.ClientException;
import idee.provider.common.dnt.DntConstants;
import idee.provider.common.dnt.ListOfGenericObjects;
import idee.provider.common.dnt.baseobjects.EstimatedTime;
import idee.provider.common.dnt.baseobjects.GenericObject;
import idee.provider.trip.TripProvider;
import idee.provider.trip.dnt.location.DntLocationProvider;
import idee.provider.trip.dnt.location.model.Area;
import idee.provider.trip.dnt.model.DntTrip;
